$(function(){
	...
	$(".sendUserMessage").click(function(){
      ...
      var passiveUser = $(this).parent().attr("friend_id");
   ...
   $(".addToFriendlist").click(function(){				   		
	   var pUser = $(this).parent().attr("friend_id");
	   var aUser = $("#sidebar").attr("user_id");
       ...
       $.post("functions/addFriend.php", {friend: pUser, user: aUser}, function(data){
	      if(data == "true"){
		      ...
		      friendContent += "</span><span class='name'>" + friendName + "</span><span class='removeFriend'>X</span></li>";
