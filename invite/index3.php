...
<head>
  ...
  <style type="text/css">
    ...
    .laptop{
	    background-image: url(../images/air_mockup.jpg);
	    background-size: cover;
    }
...
<body>
  	...
  	<div class="fullscreen">
	  	...
	  	<div class="cardSmall">
  			<div class="cardBorder">
			  	<p>Learn More<!--<img src="/images/down-arrow.png"/>--></p>
  			</div>
  		</div>
  	</div>
  	
	<!--  	
  	<div class="fullscreen laptop">
  	</div>
  	-->
  	...
  	<div>
  		<div class="card">
  			<div class="cardBorder">
			  	...
			  	<p class='extra'>The News Feed will show you a stream of the latest posts from Vancouver most followed and trusted blogs.</p>
